...
def save_checkpoint(encoder_i,decoder_t,optimizer_g,epoch, miou, args):
    ...
    checkpoint = {
        'epoch': epoch,
        'miou': miou,
        'encoder_i_state_dict': encoder_i.state_dict(),
        'decoder_t__state_dict': decoder_t.state_dict(),
...
def load_checkpoint(encoder_i,decoder_t, optimizer_g, folder_dir, filename):
    """Saves the model in a specified directory with a specified name.save
    ...
    encoder_i.load_state_dict(checkpoint['encoder_i_state_dict'])
    ...
    return encoder_i,decoder_t, optimizer_g, epoch, miou
